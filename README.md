...
## 동정 시스템 + 이달의 Ho-point 랭킹

이번 파일 세트에는 동정 후보 제안/동의/최종 선택 기능과 이달의 Ho-point 랭킹 화면이 포함되어 있습니다.

Supabase SQL Editor에서 아래 파일을 추가 실행하세요.

```text
supabase/identification_points.sql
```

Ho-point 기본 기준은 다음과 같습니다.
...
정확한 포획 위치와 포획량 경쟁을 유도하지 않도록, 랭킹은 기록 품질·종 다양성·동정 기여 중심으로 계산합니다.
