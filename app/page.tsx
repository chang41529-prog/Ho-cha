        ...
        {tab === "postDetail" && activePost && <section className="mx-auto max-w-4xl">
          ...
          <Card className="overflow-hidden rounded-3xl border-slate-200 bg-white shadow-sm">
            <div className="flex items-center gap-3 p-5">
              <div className="grid h-12 w-12 place-items-center overflow-hidden rounded-full bg-blue-50 text-xl">{activePost.avatar?.startsWith("http") ? <img src={activePost.avatar} alt={`${activePost.user} 프로필`} className="h-full w-full object-cover" /> : activePost.avatar}</div>
