  ...
  const getCurrentLocation = () => {
    ...
    navigator.geolocation.getCurrentPosition(
      (position) => {
        ...
        if (!form.location.trim()) setForm((prev) => ({ ...prev, location: "현재 위치 기반 기록" }));
        setLocationMessage(`위치 저장 준비 완료 · 정확도 약 ${Math.round(accuracy)}m. 공개 화면에는 권역명만 표시됩니다.`);
      },
